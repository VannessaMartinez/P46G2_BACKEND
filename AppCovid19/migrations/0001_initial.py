    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_divipola_municipio_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppCovid19.ubicacion')),
                ('id_evolucion_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppCovid19.seguimiento_de_cambios')),
            ],
        ),
    ]
